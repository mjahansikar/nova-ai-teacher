...
export default function App() {
  ...
  if (screen === "home") return (
    <div style={{ minHeight:"100vh", background:"#070B14", fontFamily:"Georgia,serif",
      ...
      {/* Security badge */}
      <div style={{ marginTop:24, display:"flex", alignItems:"center", gap:6, fontSize:11, color:"#334155" }}>
        <span>🔒</span> API key secured · Never exposed to browser
      </div>
    </div>
  );
    ...
    <div style={{ height:"100vh", background:"#070B14", fontFamily:"Georgia,serif",
        ...
        {loading && (
          <div style={{ display:"flex", justifyContent:"flex-start", marginBottom:12 }}>
            <div style={{ background:"#0F172A", border:"1px solid #1E293B",
              ...
              {[0,1,2].map(i => (
                <div key={i} style={{
                  width:8, height:8, borderRadius:"50%", background:color, opacity:.7,
      ...
      <div style={{ background:"#0F172A", borderTop:`1px solid ${color}20`,
        ...
        <input
          ...
          style={{
            flex:1, background:"#070B14",
            border:`1.5px solid ${input ? color+"60" : "#1E293B"}`,
            borderRadius:12, padding:"12px 16px",
            color:"white", fontSize:14, outline:"none", fontFamily:"Georgia,serif",
          }}
        />
